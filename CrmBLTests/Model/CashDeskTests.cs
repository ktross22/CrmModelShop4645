...
namespace CrmBL.Model.Tests
{
    ...
    public class CashDeskTests
    {
        ...
        public void CashDeskTest()
        {
            ...
            // act
            var cart1AclualResult = cashdesk.Dequeue();
            var cart2AclualResult = cashdesk.Dequeue();


            // assert
            Assert.AreEqual(cart1ExpectedResult, cart1AclualResult);
            Assert.AreEqual(cart2ExpectedResult, cart2AclualResult);
